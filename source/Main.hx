...
class Main extends Sprite
{
	...
	var initialState:Class<FlxState> = BootUpCheck; // The FlxState the game starts with.
	...
	public static var UPBIND:String = "J";
	public static var DOWNBIND:String = "F";
	public static var LEFTBIND:String = "D";
	public static var RIGHTBIND:String = "K";
