...
class EightAndNineBindMenu extends MusicBeatState
{
    ...
    var keyText:Array<String> = ["LEFT", "DOWN", "UP", "RIGHT", "CENTER", "LEFT", "DOWN", "UP", "RIGHT"];
    var defaultKeys:Array<String> = ["A", "S", "D", "F", FlxKey.SPACE, "H", "J", "K", "L"];
    var curSelected:Int = 0;

    var keys:Array<String> = [FlxG.save.data.mania8LeftBind,
                              FlxG.save.data.mania8DownBind,
                              FlxG.save.data.mania8UpBind,
                              FlxG.save.data.mania8RightBind,
                              FlxG.save.data.maniaCenterBind,
                              FlxG.save.data.mania8Left2Bind,
                              FlxG.save.data.mania8Down2Bind,
                              FlxG.save.data.mania8Up2Bind,
                              FlxG.save.data.mania8Right2Bind,];
	...
	{	
        ...
        var txt:FlxText = new FlxText(0, -10, FlxG.width, "8 and 9 keys - Press F1 to switch.", 32);
	...
	override function update(elapsed:Float)
	{
        ...
        {
            LoadingState.loadAndSwitchState(new BindMenu());
        }
    ...
    public function save(){
        ...
        FlxG.save.data.mania8LeftBind = keys[0];
        FlxG.save.data.mania8DownBind = keys[1];
        FlxG.save.data.mania8UpBind = keys[2];
        FlxG.save.data.mania8RightBind = keys[3];
        FlxG.save.data.maniaCenterBind = keys[4];
        FlxG.save.data.mania8Left2Bind = keys[5];
        FlxG.save.data.mania8Down2Bind = keys[6];
        FlxG.save.data.mania8Up2Bind = keys[7];
        FlxG.save.data.mania8Right2Bind = keys[8];
